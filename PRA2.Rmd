...
Podem fer un anàlisi per veure la relació entre el salari mig i el preu del lloguer. Segons les directrius estàndard d'habitatge i finances personals és recomanable que el cost de l'habitatge no superi el 35% dels ingressos totals. Aquesta anàlisi calcula la mediana dels preus anuals de lloguer per parròquia i determina quin percentatge de lloguers supera aquest llindar del 35% en relació als ingressos anuals per unitat de consum. També es calcula quantes vegades els ingressos anuals cobreixen aquest cost del lloguer, proporcionant una visió de la càrrega financera associada al lloguer en diferents parròquies.
```{r message=FALSE, warning=FALSE}
...
>
>-  Andorra-la-Vella: Amb una mitjana de lloguer anual de 37,568.20€ i una mediana de 30,000€, tots els lloguers (100%) superen el 35% dels ingressos anuals per unitat de consum. Es recomanen aproximadament 4.48 salaris per pagar el lloguer, indicant una alta càrrega de lloguer.
>
>-  Canillo: Presenta la mitjana de lloguer més alta (53,272.94€) amb una mediana també elevada (54,000€). Tot com Andorra-la-Vella, tots els lloguers superen el 35% dels ingressos, recomanant-se 6.35 salaris, el que implica una gran pressió financera pel lloguer.
>
>-  Encamp: Amb una mitjana de 26,314.29€ i una mediana similar, el 85.71% dels lloguers superen el llindar del 35% dels ingressos. Es requeririen 3.14 salaris per pagar el lloguer, una pressió financera més moderada comparada amb altres zones.
>
>-  Escaldes-Engordany: El lloguer mitjà és de 48,704.35€, amb un 95.65% dels lloguers superant el 35% dels ingressos. Es recomanen gairebé 5.8 salaris, indicant una alta càrrega de lloguer.
>
...
>
> En conclusió, aquestes dades mostren que el cost del lloguer a Andorra suposa una càrrega financera significativa en comparació amb els ingressos anuals per unitat de consum, especialment a Canillo i Escaldes-Engordany, on es requereixen més de cinc salaris per pagar el lloguer i tenir  una economia saludable. Això pot indicar una falta d'accessibilitat als habitatges per a moltes famílies, especialment en aquestes zones.
>
