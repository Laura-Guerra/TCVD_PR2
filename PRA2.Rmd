...
prop_by_zone$Ratio <- prop_by_zone$Registres / prop_by_zone$Valor
# Calcula el complement fins a 1
prop_by_zone$Complement <- 1 - prop_by_zone$Ratio

aux_data <- prop_by_zone %>%
  gather(key = "Tipo", value = "Valor", Ratio, Complement)

# Crea el gràfic de barres
ggplot(aux_data, aes(x = Zone, y = Valor, fill = Tipo)) +
